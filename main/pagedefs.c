...
const page_def_t page_defs[PAGE_COUNT] = {
    /*                 name              feeds                          draw            anim   refresh   everywhere touch saver */
    [PAGE_CLOCK]    = { "Clock",         UD_FEED(UD_CLOCK),             NULL,           false, 0,        true,  false, true  },
    ...
    [PAGE_PROJECTS] = { "By project",    UD_FEED(UD_PROJECTS),          views_projects, true,  0,        false, false, true  },
    [PAGE_YEAR]     = { "Last 12 months", UD_FEED(UD_YEAR),             views_year,     false, 0,        false, false, true  },
    [PAGE_RHYTHM]   = { "When you work", UD_FEED(UD_RHYTHM),            views_rhythm,   false, 0,        false, false, true  },
    [PAGE_COST]     = { "API cost",      UD_FEED(UD_COST),              views_cost,     true,  0,        false, false, true  },
    [PAGE_CACHE]    = { "Cache",         UD_FEED(UD_CACHE),             views_cache,    true,  0,        false, false, true  },
    [PAGE_TOOLS]    = { "Tools",         UD_FEED(UD_TOOLS),             views_tools,    true,  0,        false, false, true  },
    [PAGE_RUNS]     = { "What it runs",  UD_FEED(UD_RUNS),              views_runs,     true,  0,        false, false, true  },
    [PAGE_THINKING] = { "Thinking",      UD_FEED(UD_THINKING),          views_thinking, true,  0,        false, false, true  },
    [PAGE_RECORDS]  = { "Records",       UD_FEED(UD_RECORDS),           views_records,  false, 0,        false, false, true  },
    ...
    [PAGE_WIFI]     = { "WiFi",          0,                             NULL,           false, SEC(2),   true,  false, false },
